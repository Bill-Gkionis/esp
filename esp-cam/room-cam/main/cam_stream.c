...
static const char *TAG = "room-cam";

/* ── Wi-Fi credentials ──────────────────────────────────────────────────── */
#define WIFI_SSID   "Bill"
#define WIFI_PASS   "gavros1973"
#define WIFI_RETRY  5
...
static void start_server(void)
{
    ...
    ESP_LOGI(TAG, "Stream ready — open http://<IP>/stream in browser");
}
